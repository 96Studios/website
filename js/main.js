	...
	$.ajax({
		...
		success: function(html) {
			...
			pSingleHolder.append(
				...
				'" class="portfolio-single-inner"><span class="unslate_co--close-portfolio js-close-portfolio d-flex align-items-center"><span class="close-portfolio-label">Back to Gallery</span><span class="icon-close2 wrap-icon-close"></span></span>' + getHTMLContent + '</div>'
			);
